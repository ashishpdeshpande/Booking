...
const ListRoom = () => {
  ...
  const { axios, getToken, user, currency } = useAppContxt();
  ...
  return (
    <div>
      <Title
        ...
        font="outfit"
        title="Room Listings"
        subTitle="View, edit or manage all listed rooms. Keep the information up-to-date to provide the best experience for user."
      />
                ...
                <td className="py-3 px-4 border-t border-gray-300 text-sm text-red-500 text-center">
                  <label className="relative inline-flex items-center cursor-pointer text-gray-900 gap-3">
                    <input
                      ...
                      readOnly // To prevent React warning since checked is controlled
                    />
